...
router.get('/inquiry', setCategory("inquiry"), checkUserRole(8),postController.getAllPosts);
router.get('/inquiry/:id', setCategory("inquiry"),  checkUserRole(8),postController.getPostById);
router.post('/inquiry', setCategory("inquiry"), postController.createPost);
router.put('/inquiry', setCategory("inquiry"),  checkUserRole(8),postController.updatePost);
router.delete('/inquiry/:id', setCategory("inquiry"),  checkUserRole(8),postController.deletePost);
